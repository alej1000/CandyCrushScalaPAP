class Prueba2ParaJuntarTodo (private val rows: Int,private val cols: Int,private val data: List[Int]) {
  def this(rows: Int, cols: Int) = {
    this(rows, cols, Prueba2ParaJuntarTodo.generarMatriz(rows, cols))
  }
